...
import { requests, instance, img_api } from "../Axios";
import "./Banner.css";
...
function Banner() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      // refinedMovies видаляє всі об’єкти фільму з пошкодженими файлами зображень 
      //і вибирає випадковий фільм для відображення
  ...
  //Функція скорочує огляд фільму до максимум 150 символів
        ...
        >
          <div className="banner__contents">
            ...
            <Link to={`/movie/${movie.id}`}>
              <button className="banner__button">Подробиці</button>{" "}
            </Link>
